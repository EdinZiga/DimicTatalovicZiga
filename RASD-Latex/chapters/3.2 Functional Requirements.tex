...
\begin{itemize}[label={[\textbf{UC\arabic{ucCounter}}]}, align=left, leftmargin=*]
    \item \stepcounter{ucCounter} View Recommendations \& Offerings, Apply for Internship \\
     ...
     \begin{enumerate}[label=\arabic*.] 
        ...
        \item The student user presses the desired advertisement, and is redirected to the detailed view.
        ...
        \item The user makes the desired selection and presses 'Send'.
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \item[2a.] The platform is unable to redirect the user.
        \item[4a.] The platform fails to display the confirmation prompt.
        \item[5-6a.] The maximum number of applicants has been reached
        \end{enumerate}
    ...
    \textbf{Actors:} Company users, Student users\\
     ...
     \begin{enumerate}[label=\arabic*.] 
        ...
        \item The company user clicks the profile of a candidate they find interesting. The company user is redirected to that candidate's profile.
    ...
    \begin{enumerate}[label=\arabic*.]
        \item[*a.] At any point, the company user disconnects or the system fails:
            ...
            \end{enumerate}
        \item[1a.] The advertisement are unable to be viewed due to server error. 
        \item[2a.] The candidate profile is unable to be viewed due to server error. 
        \item[1b.; 2b.] The platform is unable to redirect the user.
        \item[4-5a.] The platform fails to display the confirmation prompt.
        \end{enumerate}


    \item \stepcounter{ucCounter} Send Prompt to Candidate (questionnaire or interview invitation)
    \textbf{Actors:} Company users, Student users\\
     \textbf{Preconditions:} The company user is logged into the platform and is viewing candidate management page for an active internship advertisement. There is at least one applicant with above Stage 1.\\
     ...
     \begin{enumerate}[label=\arabic*.] 
        ...
        \item The company user presses the 'Send Invitation button', and is notified about the successful invitation.
    ...
    \begin{enumerate}[label=\arabic*.]
        ...
        \item[2a.] The platform fails to display the confirmation prompt.
        \item[4-5a.] The system fails to process the invitation due to server error.
        \end{enumerate}


    \item \stepcounter{ucCounter} Reply to prompt
